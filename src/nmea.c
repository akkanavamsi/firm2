...
extern UART_COM_DATA uartComData4;
...
{
	char *field[50];
    char *test = &(uartComData4.receiveBuffer[3]);
    char seps[]   = ",";
    int i = 0; 
    if (strncmp(test, "RMC", 3) == 0)
    {
        char *test2 = &(uartComData4.receiveBuffer[0]);
...
{
    uartComData4.sendBuffer[0] = 0xB5;
    uartComData4.sendBuffer[1] = 0x62;
    uartComData4.sendBuffer[2] = 0x06;
    uartComData4.sendBuffer[3] = 0x01;
    
    uartComData4.sendBuffer[4] = 0x08;
    uartComData4.sendBuffer[5] = 0x00;
    uartComData4.sendBuffer[6] = 0xF1;
    uartComData4.sendBuffer[7] = 0x00;
    uartComData4.sendBuffer[8] = 0x00;
    uartComData4.sendBuffer[9] = 0x00;
    uartComData4.sendBuffer[10] = 0x00;
    uartComData4.sendBuffer[11] = 0x01;
    uartComData4.sendBuffer[12] = 0x00;
    uartComData4.sendBuffer[13] = 0x00;
    uint8_t ck_a = 0, ck_b = 0;
    int i;
    int y = 12;
    for(i=0;i<y;i++)
    {
        ck_a = ck_a + uartComData4.sendBuffer[i + 2];
        ck_b = ck_a +ck_b;
    }
    uartComData4.sendBuffer[14] = ck_a;
    uartComData4.sendBuffer[15] = ck_b;
    uartComData4.sendCount = 16;
}